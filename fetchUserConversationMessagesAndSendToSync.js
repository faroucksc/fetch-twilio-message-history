...
const client = require('twilio')(accountSid, authToken, {httpTimeout: 60000});

const phoneNumber = '+14049401288';
...
async function createSyncList(conversations) {
    const listName = 'ConversationsList';  // Name of the list (you can choose any name)
